...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Fathur Rahman</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                <a href="{{url('beranda')}}" class="nav-link {{chackRouteActive('beranda')}} ">
              ...
              <li class="nav-item">
                <a href="{{url('produk')}}" class="nav-link  {{chackRouteActive('produk')}}">
                  <i class="nav-icon fas fa-home"></i>
                  <p>
                    Produk
                  </p>
              ...
              <li class="nav-item">
                <a href="{{url('promo')}}" class="nav-link {{chackRouteActive('promo')}} ">
                  <i class="nav-icon fas fa-home"></i>
                  <p>
                    Promo
                  </p>
